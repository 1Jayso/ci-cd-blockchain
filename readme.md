...
- I was able to successfully deploy the applications follwing the instructions given I used StatefulSet instead of deployments due to the fact that blockchain nodes are stateful applications. 
